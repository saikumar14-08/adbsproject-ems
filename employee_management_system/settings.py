...
SECRET_KEY = 'django-insecure-4s!si_omm_@b&b*1acn*&#)nx6j^n_=px()*+(ypg_-nib@p%7'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dbms_project',
        'USER': 'root',
        'PASSWORD': 'Iamsai@1999',
        'HOST': 'localhost',  # Set to the appropriate host or leave as an empty string for a local database
